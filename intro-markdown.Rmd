...
> Tip: you can think of "component" and "dimension" as synonyms. This So, any time you see "principle component" or "principle component analysis" you can read those as "principle dimension" and "principle dimension analysis".
...
But why don't we just cross-analyze all the dimensions? That way we can capture all of the data's patterns, right?? Let's take a look at the graph below.
